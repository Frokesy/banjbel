  ...
  return (
    <div className="w-[90%] mx-auto py-10">
      ...
      <span className="text-[#828282] text-center text-[18px]">
        ...
        growing driving school in Oyo state and the most reviewed driving school
        ever since. Our commitment to provide unparalleled, unequal and
        unrivalled training and educational programs which has made us a trusted
