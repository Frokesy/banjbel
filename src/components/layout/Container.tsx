  ...
  return (
    <div className="w-[100%] relative justify-center items-center flex mx-auto">
      <div className="w-[100%]">
        ...
        <NavLink to="/baff" className="fixed bottom-0 lg:left-0 right-0 bg-[#3d425f] text-[#fff] italic uppercase font-bold lg:mx-4 mx-10 lg:w-[200px] w-[140px] flex justify-center items-center lg:space-x-6 space-x-4 lg:py-3 py-2 lg:mb-2 mb-16 rounded-full shadow-2xl">
